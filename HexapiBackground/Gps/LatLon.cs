...
namespace HexapiBackground.Gps
{
    internal class LatLon
    {
        ...
        internal double RtkAge { get; set; }

        internal double RtkRatio { get; set; }

        internal double Hdop { get; set; }

        internal double EastProjectionOfBaseLine { get; set; }

        internal double NorthProjectionOfBaseLine { get; set; }

        internal double UpProjectionOfBaseLine { get; set; }
