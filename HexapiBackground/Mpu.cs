...
//    sealed class MpuSensorEventArgs : EventArgs
//    {
...
//    sealed class MPU6050 : IDisposable
//    {
...
//                        var xa = (short)((int)data[0] << 8 | (int)data[1]);
//                        var ya = (short)((int)data[2] << 8 | (int)data[3]);
//                        var za = (short)((int)data[4] << 8 | (int)data[5]);

//                        var xg = (short)((int)data[6] << 8 | (int)data[7]);
//                        var yg = (short)((int)data[8] << 8 | (int)data[9]);
//                        var zg = (short)((int)data[10] << 8 | (int)data[11]);

//                        var sv = new MpuSensorValue
//                        {
//                            AccelerationX = (float) xa/(float) 16384,
//                            AccelerationY = (float) ya/(float) 16384,
//                            AccelerationZ = (float) za/(float) 16384,
//                            GyroX = (float) xg/(float) 131,
//                            GyroY = (float) yg/(float) 131,
//                            GyroZ = (float) zg/(float) 131
//                        };
...
//                    //if (ea.Values.Length >= 1)
//                    //{
//                    //    var Roll = Math.Atan2(ea.Values[0].AccelerationY, ea.Values[0].AccelerationZ) * 180 / Math.PI;
//                    //    var Pitch = Math.Atan2(-ea.Values[0].AccelerationX, Math.Sqrt(ea.Values[0].AccelerationY * ea.Values[0].AccelerationY + ea.Values[0].AccelerationZ * ea.Values[0].AccelerationZ)) * 180 / Math.PI;
//                    //}
...
//        double[] GetQuaternion(byte[] packet) //???????? not sure about this
//        {
//            var data=new double [] { 0,0,0,0 };
